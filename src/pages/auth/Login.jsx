    ...
    <div className="auth-outer">
      ...
      <div className="auth-card" style={{ background: 'linear-gradient(180deg, #f0f9ff 0%, #ffffff 100%)' }}>
        <div className="flex flex-col min-h-full px-7 py-8 lg:py-10 relative">
          {/* Mobile brand */}
          <div className="flex justify-center mb-6 mt-2 lg:hidden">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-sky-600 to-cyan-400 flex items-center justify-center shadow-nutrisea">
                <span className="text-white font-black text-xl">N</span>
              </div>
              <div>
                <p className="font-black text-sky-700 text-xl tracking-tight">NutriSea</p>
                <p className="font-bold text-slate-400 text-xs uppercase tracking-widest">Gizi Anak</p>
              </div>
            </div>
          </div>

          <h2 className="text-2xl font-black text-slate-900 mb-1">Masuk ke Akun</h2>
          <p className="text-sm text-slate-500 font-semibold mb-6">Pantau tumbuh kembang si kecil bersama NutriSea 🐠</p>
          ...
          <div className="mt-4 border-2 border-dashed border-sky-100 rounded-2xl p-4">
            ...
            <div className="grid grid-cols-2 gap-2 text-xs">
              <div className="bg-sky-50 rounded-xl p-2.5">
                ...
                <p className="text-slate-600 font-bold break-all">user@bilova.com</p>
              ...
              <div className="bg-sky-50 rounded-xl p-2.5">
                ...
                <p className="text-slate-600 font-bold break-all">admin@bilova.com</p>
                <p className="text-slate-400 font-semibold">Pass: 12345678</p>
              </div>
            </div>
          </div>
